...
import About from "../public/damiportraitbg.png";
  ...
  return (
    <DefaultLayout>
      <div className="container mx-auto py-12 px-4">
        ...
        <div className="mb-12">
          <p className="text-xl text-center text-[#006950] font-bold mb-5">
        ...
        <section className="bg-[#006950] text-white p-6 rounded-lg shadow-lg text-center mb-12">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-3 text-center mt-7 mx-auto">
            {!user ? (
              <>
                <Link href="/register">
                  <button className="text-[#006950] bg-white hover:bg-white hover:text-[#006950] px-3 py-2 rounded-md text-sm font-medium mr-4">
                    Sign Up
                  </button>
                </Link>
                <Link href="/login">
                  <button className="text-white bg-[#717788] hover:bg-white hover:text-[#006950] px-3 py-2 rounded-md text-sm font-medium">
                    Sign In
                  </button>
                </Link>
              </>
        ...
        <section className="mb-12 text-center">
          <h2 className="text-[#0b2546] text-3xl font-bold text-gray-800 mb-4">
            About PurposefulPath's 'Growth Convener'
          </h2>
          <h3 className="text-[#0b2546] text-2xl font-bold text-gray-800 mb-4">
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-100 py-6 px-4 rounded-lg shadow-md">
            <p class="text-gray-700">
              ...
              Interface Management and Contract Administration for Oil &amp;
              Gas, Telecoms, infrastructure projects and ‘the emerging
              Technology Space in West Africa’. His guiding principles are
              Integrity, Creativity, Excellence and Continuous learning.
            </p>
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-center mb-7">Testimonials</h2>
          <div>
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-1">
              ...
              >
                <p
                  ...
                  data-aos-delay="400"
                >
                  "Working with Damilola was quite an interesting one. I was at
                  a very critical point in my life when our paths crossed and
                  I'll always be grateful for that opportunity. There wasn't a
                  dull moment from top-notch deliverables and emphasizing the
                  outsider's perspective in any given task informed my diligence
                  while working with him. Thanks for all you do for me. I
                  recommend Damilola because you can rest assured of a healthy
                  work-life balance and fulfillment in career achievement "-
                  Adebanjo Adeniji
                </p>
              </div>
              <div
                className=" text- p-6 rounded-lg shadow-lg"
                data-aos="fade-down"
                data-aos-delay="400"
              >
                <p
                  ...
                  data-aos-delay="400"
                >
                  "I worked with Dami as my team lead. He led with dedication to
                  his work and inspiration to his team members. Working with
                  him, you would definitely see his zeal to work, gusto, and
                  hands-on approach to problem-solving, team building &
